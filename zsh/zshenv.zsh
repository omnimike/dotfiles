...
local PYTHON_PATH="/Users/mfulthorp/Library/Python/3.6/bin"
export NVM_DIR="$HOME/.nvm"
export JAVA_HOME="/Library/Java/JavaVirtualMachines/jdk1.8.0_162.jdk/Contents/Home"
export MAVEN_PATH=/usr/local/Cellar/maven/3.5.3
export PATH="$PATH:$HOME/bin:$BREW_PATH:$PYTHON_PATH:$RUST_PATH:$SUBL_PATH:$LOCAL_PATH:$YARN_PATH:$GO_PATH:$TEX_PATH:$COMPOSER_PATH"
